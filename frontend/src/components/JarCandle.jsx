...
function Flame({ cx, cy }) {
  return (
    <>
      <ellipse cx={cx} cy={cy} rx="6" ry="10.5" fill="#EFAE5C" opacity="0.92" />
      <ellipse cx={cx} cy={cy + 3} rx="3.4" ry="6.2" fill="#F9D888" />
      <ellipse cx={cx} cy={cy + 5} rx="1.7" ry="2.8" fill="#FFF6DE" />
    </>
  );
}

function GlassHighlight({ x, y, h }) {
  return <rect x={x} y={y} width="4" height={h} rx="2" fill="#fff" opacity="0.35" />;
}
...
export function JarCandle({ jarTypeId, rgb, lit, size = 130, showFace = false }) {
  ...
  const shadow = <ellipse cx="60" cy="163" rx="30" ry="5" fill={T.pinkSoft} opacity="0.55" />;
  const strokeCol = T.pinkDeep;
    ...
    case "square":
      content = (
        <>
          ...
          {!lit && <ellipse cx="60" cy="40" rx="34" ry="8" fill="#C4A876" stroke={strokeCol} strokeWidth="1.5" strokeOpacity="0.4" />}
          {lit && <ellipse cx="94" cy="34" rx="18" ry="6" fill="#C4A876" opacity="0.85" transform="rotate(-18 94 34)" />}
          {lit && <ellipse cx="60" cy="54" rx="24" ry="7" fill={rgbStr(melt)} />}
          <line x1="60" y1={lit ? 54 : 60} x2="60" y2="38" stroke="#8a6a48" strokeWidth="2" strokeLinecap="round" />
    ...
    case "cone":
      content = (
        <>
          ...
          <line x1="60" y1={lit ? 48 : 52} x2="60" y2="32" stroke="#8a6a48" strokeWidth="2" strokeLinecap="round" />
    ...
    case "tall":
      content = (
        <>
          ...
          <line x1="60" y1={lit ? 38 : 42} x2="60" y2="22" stroke="#8a6a48" strokeWidth="2" strokeLinecap="round" />
    ...
    case "bottle":
      content = (
        <>
          ...
          {!lit && <path d="M 55 40 L 65 40 L 63 30 L 57 30 Z" fill="#B98A5C" />}
          {lit && <path d="M 82 34 L 90 34 L 88 24 L 84 24 Z" fill="#B98A5C" transform="rotate(20 86 29)" />}
          <line x1="60" y1={lit ? 55 : 48} x2="60" y2="34" stroke="#8a6a48" strokeWidth="1.8" strokeLinecap="round" />
    ...
    case "tin":
      content = (
        <>
          ...
          <ellipse cx="102" cy="98" rx="16" ry="5" fill="#C9C2AE" stroke={strokeCol} strokeWidth="1.2" strokeOpacity="0.4" transform="rotate(-12 102 98)" />
          <line x1="60" y1={lit ? 110 : 104} x2="60" y2="92" stroke="#8a6a48" strokeWidth="2" strokeLinecap="round" />
    ...
    case "bowl":
      content = (
        <>
          ...
          <line x1="60" y1={lit ? 112 : 112} x2="60" y2="96" stroke="#8a6a48" strokeWidth="2" strokeLinecap="round" />
    ...
    case "heart": {
      ...
      content = (
        <>
          ...
          <ellipse cx="42" cy="66" rx="7" ry="12" fill="#fff" opacity="0.3" transform="rotate(-18 42 66)" />
          {lit && <ellipse cx="60" cy="78" rx="17" ry="7" fill={rgbStr(melt)} />}
          <line x1="60" y1={lit ? 78 : 80} x2="60" y2="62" stroke="#8a6a48" strokeWidth="2" strokeLinecap="round" />
    ...
    case "hexagon":
      content = (
        <>
          ...
          {lit && <ellipse cx="60" cy="54" rx="24" ry="7" fill={rgbStr(melt)} />}
          <line x1="60" y1={lit ? 54 : 58} x2="60" y2="38" stroke="#8a6a48" strokeWidth="2" strokeLinecap="round" />
          {lit && <Flame cx={60} cy={30} />}
        </>
      );
      break;
    case "mason":
      content = (
        <>
          ...
          <rect x="42" y="30" width="36" height="16" rx="3" fill="#B7A986" stroke={strokeCol} strokeWidth="1.5" strokeOpacity="0.5" />
          ...
          <path d="M 26 70 Q 14 90 26 112" fill="none" stroke="#9C9284" strokeWidth="2.4" opacity="0.7" />
          {lit && <ellipse cx="60" cy="62" rx="24" ry="6" fill={rgbStr(melt)} />}
          <line x1="60" y1={lit ? 62 : 50} x2="60" y2="48" stroke="#8a6a48" strokeWidth="2" strokeLinecap="round" />
    ...
    default: // round
      content = (
        <>
          ...
          <line x1="60" y1={lit ? 52 : 56} x2="60" y2="36" stroke="#8a6a48" strokeWidth="2" strokeLinecap="round" />
